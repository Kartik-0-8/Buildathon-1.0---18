...
import { Plus, Users, MessageSquare, BarChart, X, Edit } from 'lucide-react';
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col">
                    <div className="border-b border-gray-100 dark:border-gray-700 px-6 py-4 flex gap-6">
                        ...
                        <button 
                            ...
                            className={`text-sm font-medium pb-4 -mb-4 border-b-2 transition-colors ${activeTab === 'drafts' ? 'border-primary-600 text-primary-600' : 'border-transparent text-gray-500'}`}
                        >
                            Drafts
                        </button>
                    </div>
                    <div className="p-6 flex-1">
                        {activeTab === 'active' ? (
                                ...
                                {MOCK_HACKATHONS.slice(0, 3).map(h => (
                                    <div key={h.id} className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700/50 group">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">{h.participants} participants</p>
                                        </div>
                                        <button 
                            ...
                            <div className="text-center text-gray-500 py-10">No drafts.</div>
                        )}
                    </div>
                </div>
